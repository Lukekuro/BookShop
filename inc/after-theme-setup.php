...
if ( ! function_exists( 'itm_setup' ) ) :
	...
	function itm_setup() {
		 ...
		 * to change 'it_book' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'it_book', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			[
				'main'   => esc_html__( 'Main Nav', 'it_book' ),
				'footer' => esc_html__( 'Footer Nav', 'it_book' ),
			]
		);
