...
<footer class="site-footer">
	...
	<div class="site-footer__copyright">
		<div class="container">
			...
			<span><?php echo sprintf( esc_html__( '&copy; %s All rights reserved', 'it_book' ), esc_html( date( 'Y' ) ) ); // @phpcs:disable ?></span>
		</div>
	</div>
</footer>
...
<?php if ( $enable_to_top && ! is_404() ) : ?>
	<a id="to-top" href="#top">
		...
		<span class="screen-reader-text"><?php esc_html_e( 'Scroll to top', 'it_book' ); ?></span>
	</a>
<?php endif; ?>
