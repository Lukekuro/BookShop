...
* Replace original Text Domain `it_book` with your custom name. In **gulpfile.js** change textdomain with your custom name, and run gulp task: `gulp textdomain`.
...
Now you can use commands `phpcs path/to/your-file.php` or simply `phpcs` inside the folder with your files.
